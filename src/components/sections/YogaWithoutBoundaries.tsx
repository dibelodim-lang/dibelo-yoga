    ...
    <section className="section-padding bg-background relative overflow-hidden" ref={ref}>
      ...
      <div className="container-narrow relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => <motion.div key={index} initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8, delay: 0.3 + index * 0.15 }} className="p-8 border border-border bg-card text-center">
